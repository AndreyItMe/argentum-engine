...
value class Subtype(val value: String) {
    ...
    companion object {
        ...
        val DEMIGOD = Subtype("Demigod")
        val DETECTIVE = Subtype("Detective")
        val DEVIL = Subtype("Devil")
        val DINOSAUR = Subtype("Dinosaur")
        val DJINN = Subtype("Djinn")
        val DOCTOR = Subtype("Doctor")
        val DOG = Subtype("Dog")
        ...
        val ELK = Subtype("Elk")
        val ETERNAL = Subtype("Eternal")
        val FOX = Subtype("Fox")
        val FRACTAL = Subtype("Fractal")
        val FUNGUS = Subtype("Fungus")
        val GAMMA = Subtype("Gamma")
        ...
        val PERFORMER = Subtype("Performer")
