...
object SetArchetypes {
    ...
    private val allSets: Map<String, SetSynergies> = mapOf(
        ...
        "BLB" to SetSynergies(
            ...
            setName = "Bloomburrow",
            archetypes = listOf(
                Archetype("Bats", listOf(Color.WHITE, Color.BLACK),
                    "Use life as a resource — white gains it, black spends it. Bats reward you for both gaining and losing life, letting you flip between aggression and defense as needed.",
                    creatureTypes = listOf("Bat")),
                Archetype("Otters", listOf(Color.BLUE, Color.RED),
                    "Cast a high volume of instants and sorceries to trigger Prowess on your Otter creatures. Classic Izzet spell-slinger that gets bigger the more spells you cast.",
                    creatureTypes = listOf("Otter")),
                Archetype("Frogs", listOf(Color.BLUE, Color.GREEN),
                    "Value engine built around bouncing and blinking Frogs to re-trigger ETB effects. Mana-intensive but generates enormous card advantage in the late game.",
                    creatureTypes = listOf("Frog")),
                Archetype("Lizards", listOf(Color.BLACK, Color.RED),
                    "Aggressive deck that rewards dealing damage to opponents and forcing life loss. Creatures gain bonuses when opponents lose life, combining relentless pressure with black removal.",
                    creatureTypes = listOf("Lizard")),
                Archetype("Squirrels", listOf(Color.BLACK, Color.GREEN),
                    "Grindy midrange built around the Forage mechanic — sacrifice Food tokens or exile cards from graveyards for value. Squirrels synergize with food production and graveyard interactions.",
                    creatureTypes = listOf("Squirrel")),
                Archetype("Rabbits", listOf(Color.GREEN, Color.WHITE),
                    "Flood the board with Rabbit tokens, then use mass pump and anthem effects to swing for lethal all at once. One of the most popular and powerful archetypes in the format.",
                    creatureTypes = listOf("Rabbit")),
                Archetype("Birds", listOf(Color.WHITE, Color.BLUE),
                    "Take to the skies with evasive Birds backed by tempo and card selection. Payoffs reward flyers connecting in combat, letting a small aerial force close out games while you hold the ground.",
                    creatureTypes = listOf("Bird")),
                Archetype("Mice", listOf(Color.RED, Color.WHITE),
                    "Aggressive go-wide Mice that reward attacking with a swarm of small creatures. Valiant triggers fire when you target your own attackers with combat tricks and Equipment, turning cheap creatures into real threats.",
                    creatureTypes = listOf("Mouse")),
                Archetype("Raccoons", listOf(Color.RED, Color.GREEN),
                    "Ramp-fueled midrange built on the Expend mechanic — spend mana across a turn to unlock escalating payoffs, then overwhelm the board with oversized Raccoons and big green threats.",
                    creatureTypes = listOf("Raccoon")),
            )
        ),
        "ECL" to SetSynergies(
            setCode = "ECL",
            ...
            archetypes = listOf(
                ...
                Archetype("Elves", listOf(Color.BLACK, Color.GREEN),
                    "Grindy self-mill midrange that treats the graveyard as a resource. A high Elf count powers kindred payoffs while Blight and recursion let you out-value every other midrange deck in the format.",
                    creatureTypes = listOf("Elf")),
